...
<table width="700" cellspacing="0" cellpadding="0">
                                ...
                                <td>
                                    <table width="250" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        ...
                                        <td><input type="text" name="id" id="id" style="height: 16px; width: 85px; border: 1px solid #CCCCCC; margin: 0px; padding: 0px; ime-mode: disabled;" tabindex="4" maxlength="10" value="TEST1"/></td>
                                        <td/>
                                      </tr>
                                      <tr>
                                        <td class="required_text" nowrap><label for="password">비밀번호&nbsp;&nbsp;</label></td>
                                        <td><input type="password" name="password" id="password" style="height: 16px; width: 85px; border: 1px solid #CCCCCC; margin: 0px; padding: 0px; ime-mode: disabled;" maxlength="12" tabindex="5" value="rhdxhd12" onKeyDown="javascript:if (event.keyCode == 13) { actionLogin(); }"/></td>
  ...
  <%-- <table width="700">
	...
	<table class="inline" style="">
		<tbody><tr class="row0">
			<th class="col0">구분</th><th class="col1">ID</th><th class="col2">PW</th><th class="col3">비고</th>
		</tr>
		<tr class="row1">
			<td class="col0"> 업무사용자 </td><td class="col1"> TEST1 </td><td class="col2"> rhdxhd12 </td><td class="col3"> 영문으로 공통12 </td>
		</tr>
		<tr class="row2">
			<td class="col0"> </td><td class="col1"> webmaster </td><td class="col2"> rhdxhd12 </td><td class="col3"> 영문으로 공통12 </td>
		</tr>
		<tr class="row3">
			<td class="col0"> 일반사용자 </td><td class="col1"> USER </td><td class="col2"> rhdxhd12 </td><td class="col3"> 영문으로 공통12 </td>
		</tr>
		<tr class="row4">
			<td class="col0"> 기업사용자 </td><td class="col1"> ENTERPRISE </td><td class="col2"> rhdxhd12 </td><td class="col3"> 영문으로 공통12 </td>
		</tr>
	</tbody></table>
</body>
</html>
